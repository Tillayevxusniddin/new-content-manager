...
export const categories: Category[] = [
	{
		...
		icon: 'Users',
		count: 21,
		accent: 'from-cyan-500/20 to-cyan-400/5 text-cyan-300'
	},
	{
		id: 'cat-2',
		name: '自己啓発',
		icon: 'Sparkles',
		count: 18,
		accent: 'from-emerald-500/20 to-emerald-400/5 text-emerald-300'
	},
	{
		id: 'cat-3',
		name: 'テクノロジー',
		icon: 'Cpu',
		count: 15,
		accent: 'from-violet-500/20 to-violet-400/5 text-violet-300'
	},
	{
		id: 'cat-4',
		name: '心理学',
		icon: 'Brain',
		count: 12,
		accent: 'from-amber-500/20 to-amber-400/5 text-amber-300'
	},
	{
		id: 'cat-5',
		name: '起業',
		icon: 'Rocket',
		count: 9,
		accent: 'from-rose-500/20 to-rose-400/5 text-rose-300'
	},
	{
		id: 'cat-6',
		name: 'マネジメント',
		icon: 'Briefcase',
		count: 24,
		accent: 'from-blue-500/20 to-blue-400/5 text-blue-300'
	},
	{
		id: 'cat-7',
		name: 'マーケティング',
		icon: 'TrendingUp',
		count: 16,
		accent: 'from-orange-500/20 to-orange-400/5 text-orange-300'
	}
]
...
export const books: BookSummary[] = [
	{
		...
		description:
			'リーダーシップの本質を探求し、チームを成功へ導くための実践的なフレームワークを提供します。',
		categoryId: 'cat-1',
