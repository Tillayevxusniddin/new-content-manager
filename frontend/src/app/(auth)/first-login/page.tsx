...
export default function FirstLoginPage() {
	...
	return (
		<div className='bg-background text-foreground relative min-h-screen px-4'>
			{/* <div className='absolute inset-0 bg-[radial-gradient(circle_at_20%_15%,hsl(var(--primary)/0.2),transparent_30%),radial-gradient(circle_at_82%_20%,hsl(var(--accent)/0.18),transparent_28%),radial-gradient(circle_at_50%_100%,hsl(var(--chart-2)/0.14),transparent_30%)]' />
			<div className='absolute inset-0 bg-[linear-gradient(135deg,hsl(var(--foreground)/0.05)_0%,transparent_18%,transparent_82%,hsl(var(--foreground)/0.03)_100%)]' /> */}

			<div className='relative mx-auto flex min-h-screen max-w-4xl items-center justify-center'>
				<Card className='border-border bg-card/75 w-full shadow-[0_24px_140px_hsl(var(--foreground)/0.12)] backdrop-blur-2xl'>
