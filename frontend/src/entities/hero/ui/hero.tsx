			...
			<div className='relative grid gap-8 lg:grid-cols-[1fr_240px] lg:items-center'>
				<div className='space-y-5'>
					...
					<div className='rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4'>
						<p className='text-[11px] tracking-[0.2em] text-zinc-500 uppercase'>Featured Summary</p>
						...
						<p className='mt-3 line-clamp-2 text-sm text-zinc-300'>{featured.description}</p>
					</div>
					<div className='flex flex-wrap items-center gap-3'>
						...
						<Link href='/books'>
							<Button size='lg' variant='outline' className='border-zinc-700 bg-zinc-900 text-zinc-200 hover:bg-zinc-800'>
								書籍一覧へ
